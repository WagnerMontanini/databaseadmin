...
class ToolsModule(PgAdminModule):
    def register(self, app, options):
        ...
        from .sql_export import blueprint as module
...
def translations():
    ...
    template = render_template("js/translations.js", translations=translations._catalog)
    return Response(response=template, status=200, mimetype=MIMETYPE_APP_JS)


@blueprint.route("/initialize/", methods=["GET"], endpoint="initialize")
def initialize():
